...
ifeq ("$(wildcard $(EDK2_BIN))","")
	mkdir -p $(EDK2_PATH)
	wget -O $(EDK2_BIN) \
		http://snapshots.linaro.org/components/kernel/leg-virt-tianocore-edk2-upstream/latest/QEMU-KERNEL-AARCH64/DEBUG_GCC49/QEMU_EFI.fd
endif
...
benchmark-clean: benchmark-clean-common
