...
extern struct tee_device *global_teedev_guy;

struct tee_shm *global_shm_alloc(size_t size, u32 flags)
{
    struct tee_device *teedev = global_teedev_guy;
...
EXPORT_SYMBOL_GPL(global_shm_alloc);
